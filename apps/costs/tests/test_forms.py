...
class CostCategoryFormsTest(TestCase):
    ...
    def test_add_cost_category(self) -> None:
       """Создание новой категории затрат"""
        categories_count: int = CostCategory.objects.count()
    ...
    def test_add_existing_cost_category(self) -> None:
    ...
    def test_update_own_category(self) -> None:
    ...
    def test_update_std_category(self) -> None:
    ...
    def test_update_another_users_category(self) -> None:
        form_data = {'name': 'asd'}
        self.authorized_client.post(
    ...
    def test_delete_own_category(self) -> None:
    ...
    def test_delete_standart_category(self) -> None:
    ...
    def test_delete_other_users_category(self) -> None:
...
class CostFormsTest(TestCase):
    ...
    def test_add_cost_with_standart_category(self) -> None:
    ...
    def test_add_cost_with_custom_category(self) -> None:
    ...
    def test_add_cost_with_other_user_category(self) -> None:
    ...
    # def test_update_own_cost(self) -> None:
    ...
    def test_update_other_users_cost(self) -> None:
